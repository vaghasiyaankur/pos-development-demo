                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ __('messages.module') }} {{ __('messages.section') }}">{{ __('messages.module') }}
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('module'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/module*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ __('messages.module') }}">
                                <i class="tio-globe nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('messages.module') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ __('messages.add') }} {{ __('messages.module') }}">
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.module.index') }}" title="{{ __('messages.models') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ __('messages.modules') }}
                                        </span>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ __('messages.parcel') }} {{ __('messages.section') }}">{{ __('messages.parcel') }}
                            {{ __('messages.section') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('parcel'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/parcel*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ __('messages.parcel') }}">
                                <i class="tio-bus nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('messages.parcel') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ __('messages.parcel_category') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ __('messages.parcel') }} {{ __('messages.orders') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ __('messages.parcel') }} {{ __('messages.settings') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ __('messages.store') }} {{ __('messages.section') }}">{{ __('messages.store') }}
                            {{ __('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-item {{ Request::is('admin/vendor/list') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('messages.stores') }}
                                            {{ __('list') }}</span>
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ __('messages.item') }} {{ __('messages.section') }}">{{ __('messages.item') }}
                            {{ __('messages.management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('withdraw_list'))
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('messages.store') }}
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('report'))
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('admin.report.item-wise-report') }}"
                                ...
                                <span class="tio-report nav-icon"></span>
                                <span class="text-truncate">{{ __('messages.item_wise_report') }}</span>
                            </a>
                        </li>
                    @endif
