    ...
    <div class="navbar-header">
        <div class="d-flex align-items-center">
            ...
            <div class="navbar-header-links">
                <button type="button" class="btn btn-success px-5 fs-5"><i class="fa-solid fa-angles-left pe-2"></i>
                    <span>Back</span>
                </button>
            </div>
        </div>
    ...
    <div id="scrollbar">
        <div class="container-fluid m-0 ps-2">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link menu-link ps-0 active" href="{{ route('dashboard.index') }}">
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Dashboards</span>
                    </a>
                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('pos.index') }}">
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">POS</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="menu-title">
                    <a class="nav-link menu-link " href="{{ route('order.index') }}">
                        <i class="ri-more-fill"></i> <span data-key="t-pages">Orders</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Expense</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="layouts-detached.html" target="_blank" class="nav-link"
                                    data-key="t-detached">Categories</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth">Customers</span>
                    </a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="pages-starter.html" class="nav-link" data-key="t-starter"> Service
                                    List
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarProfile" class="nav-link"> Service Type
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-team.html" class="nav-link" data-key="t-team"> Addons </a>
                            </li>
